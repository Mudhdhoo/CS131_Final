...
# Import image
img = io.imread('images/flower_yellow.jpeg', as_gray = True)
truth = np.load('results/flower_truth.npy')
img_orig = img.copy()
m, n = img.shape
...
seg_raw, phi = chan_vese(img, mu=0.5, init_level_set='checkerboard', max_num_iter=200)
...
seg_init, phi = chan_vese(img_recon_init, mu=0.5, init_level_set='checkerboard', max_num_iter=200)
...
plt.imshow(img_orig)
plt.axis('off')
fig.savefig('results_flower/original_flower.png', bbox_inches='tight', pad_inches=0) 

fig = plt.figure()
plt.imshow(img)
plt.axis('off')
fig.savefig('results_flower/damaged_flower.png', bbox_inches='tight', pad_inches=0) 

fig = plt.figure()
plt.imshow(img_recon)
plt.axis('off')
fig.savefig('results_flower/reconstructed_flower.png', bbox_inches='tight', pad_inches=0) 

fig = plt.figure()
plt.imshow(truth)
plt.axis('off')
fig.savefig('results_flower/true_seg_flower.png', bbox_inches='tight', pad_inches=0) 

fig = plt.figure()
plt.imshow(seg)
plt.axis('off')
fig.savefig('results_flower/flower_seg.png', bbox_inches='tight', pad_inches=0) 

fig = plt.figure()
plt.imshow(seg_raw)
plt.axis('off')
fig.savefig('results_flower/flower_chan_vese.png', bbox_inches='tight', pad_inches=0) 

fig = plt.figure()
plt.imshow(seg_init)
plt.axis('off')
fig.savefig('results_flower/flower_seg_init.png', bbox_inches='tight', pad_inches=0) 

fig = plt.figure()
plt.imshow(img_recon_init)
plt.axis('off')
fig.savefig('results_flower/flower_recon_init.png', bbox_inches='tight', pad_inches=0) 
